...
//contact details
global.ownernumber = [ process.env.OWNER_NUMBER || "972523427643"],
global.ownername = process.env.OWNER_NAME || "Holland Techs",
global.location = "Israel"

global.botname = process.env.BOTNAME || "בוט מעקב הוצאות הבית",//name of the bot

//sticker details
global.stickername = process.env.STICKER || "Holland Techs",
global.packname = 'Sticker By'
global.author = process.env.AUTHOR || "Holland Techs",
//console view/theme
global.themeemoji = '🧩'
global.wm = "Holland Techs inc."
